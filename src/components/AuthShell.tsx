  ...
  return (
    <div className="grid grid-cols-2 gap-2">
      {[
        {
          name: "Google",
          svg: "M21.35 11.1H12v2.92h5.34c-.23 1.5-1.66 4.4-5.34 4.4-3.21 0-5.84-2.66-5.84-5.92S8.79 6.58 12 6.58c1.83 0 3.05.78 3.75 1.45l2.56-2.46C16.78 3.99 14.6 3 12 3 6.93 3 2.83 7.1 2.83 12.17S6.93 21.34 12 21.34c6.92 0 9.5-4.86 9.5-7.41 0-.5-.07-.88-.15-1.27z",
        },
        {
          name: "Apple",
          svg: "M16.36 12.42c-.02-2.4 1.96-3.55 2.05-3.6-1.12-1.64-2.86-1.86-3.48-1.89-1.48-.15-2.89.87-3.64.87-.76 0-1.92-.85-3.16-.83-1.62.02-3.13.95-3.96 2.4-1.69 2.93-.43 7.25 1.22 9.62.8 1.16 1.76 2.46 3.01 2.42 1.21-.05 1.67-.78 3.14-.78 1.46 0 1.88.78 3.16.76 1.31-.02 2.14-1.18 2.94-2.34.93-1.34 1.31-2.64 1.33-2.71-.03-.01-2.55-.98-2.6-3.9zM14.04 5.32c.67-.82 1.13-1.95.99-3.07-.96.04-2.13.64-2.83 1.45-.62.72-1.18 1.88-1.04 2.99 1.08.08 2.2-.55 2.88-1.37z",
        },
      ].map((p) => (
        <button
          key={p.name}
