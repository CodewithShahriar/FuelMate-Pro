...
function StationsPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5 text-foreground">
      ...
      <div className="rounded-3xl bg-card p-5 text-foreground shadow-card">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Quick list for now, map can come later.</p>
          </div>
        </div>
      </div>
      <div className="space-y-3">
        {stations.map((station) => (
          <article
            key={station.name}
            className="rounded-3xl bg-card p-4 text-foreground shadow-card"
          >
